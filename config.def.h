...
static const char *playctl[] = { "playerctl", "play-pause", NULL  };
static const char *stopctl[] = { "playerctl", "stop", NULL  };
static const char *nextctl[] = { "playerctl", "next", NULL  };
static const char *prevctl[] = { "playerctl", "previous", NULL  };
